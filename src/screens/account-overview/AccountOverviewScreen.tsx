  ...
  return (
    <div style={{ padding: '24px 20px 32px' }}>
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: [0.16, 1, 0.3, 1] }}>
        <h1 style={{ fontSize: '26px', fontWeight: 700, color: '#f5f7ff', letterSpacing: '-0.02em', marginBottom: '8px' }}>Account Overview</h1>
        <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.4)' }}>Complete picture of your finances</p>

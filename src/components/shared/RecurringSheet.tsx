...
export function RecurringSheet({ open, onClose, onSave }: Props) {
  ...
  const reset = () => {
    ...
    setFrequency('monthly'); setNextDue(''); setNotes(''); setErr('')
  }
        ...
        <>
          ...
          <motion.div
            ...
            style={{
              ...
              border: '1px solid rgba(165,180,252,0.22)', borderBottom: 'none',
          ...
          >
            ...
            <label style={{ display: 'block', marginBottom: 14 }}>
              ...
              <input
                type="text" placeholder="e.g. Netflix, Rent, Jio Recharge"

  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '14px 14px 10px' }}>
        ...
        {/* Center: label + meta — takes all available space */}
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ fontSize: 13, fontWeight: 700, color: '#f5f7ff', margin: '0 0 4px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {asset.label}
          </p>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'nowrap', overflow: 'hidden' }}>
            ...
            {asset.current_price != null && (
              <span style={{ fontSize: 11, fontWeight: 600, color: '#fcd34d', whiteSpace: 'nowrap', flexShrink: 0, overflow: 'hidden', textOverflow: 'ellipsis' }}>
        ...
        {/* Right: value + PnL — fixed max-width so it never squeezes center */}
        <div style={{ flexShrink: 0, maxWidth: '42%', textAlign: 'right' }}>
          <p style={{ fontSize: 13, fontWeight: 800, color: '#fcd34d', margin: 0, fontVariantNumeric: 'tabular-nums', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          ...
          {pnlAbs !== null && pnlPct !== null && Math.abs(pnlAbs) >= 0.01 && (
            <div style={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'flex-end', marginTop: 3 }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 700, color: pnlGain ? '#34d399' : '#f87171', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums' }}>

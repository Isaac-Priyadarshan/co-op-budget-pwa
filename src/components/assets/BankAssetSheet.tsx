        ...
        <>
          ...
          >
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {ACCOUNT_TYPES.map(t => (
                  <motion.button
                    ...
                    style={{
                      padding: '9px 18px', borderRadius: 100, fontSize: 13, fontWeight: accountType === t ? 700 : 400,
            ...
            <label style={{ display: 'block', marginBottom: 18 }}>
              ...
              <input
                ...
                style={{
                  width: '100%', padding: '13px 16px',
                  background: 'rgba(96,165,250,0.06)', border: '1px solid rgba(96,165,250,0.2)',
                  borderRadius: 14, color: '#93c5fd', fontSize: 28, fontWeight: 800,
            ...
            <label style={{ display: 'block', marginBottom: 24 }}>
              ...
              <input
                type="text" placeholder="Branch, account ending, any detail"

          ...
          >
            ...
            <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', padding: '0 20px 8px' }}>
              ...
              <div style={{ marginBottom: 18 }}>
                <p style={{ fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: 10 }}>
                  Account Type
                </p>
              ...
              <label style={{ display: 'block', marginBottom: 18 }}>
                ...
                <input
                  type="number" inputMode="decimal" placeholder="e.g. 6.5"
                  value={interestRate}

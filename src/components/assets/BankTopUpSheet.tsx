          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 26, padding: '0 20px', flexShrink: 0 }}>
              ...
              <div>
                ...
                <h2 style={{ fontSize: 20, fontWeight: 800, color: '#f5f7ff', letterSpacing: '-0.02em', margin: 0 }}>{bankLabel}</h2>
            ...
            <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', padding: '0 20px 8px' }}>
              <label style={{ display: 'block', marginBottom: 18 }}>
                <p style={{ fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: 8 }}>Top-Up Amount (₹)</p>
              ...
              <label style={{ display: 'block', marginBottom: 18 }}>
                <p style={{ fontSize: 11, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', marginBottom: 8 }}>Top-Up Date</p>
              ...
              <label style={{ display: 'block', marginBottom: 20 }}>
                ...
                <input type="text" placeholder="Any detail about this deposit" value={notes} onChange={e => setNotes(e.target.value)}
                  style={inputStyle}
                />
              </label>
              {err && (

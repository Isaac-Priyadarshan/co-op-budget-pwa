          ...
          >
            ...
            <div style={{ flex: 1, overflowY: 'auto', WebkitOverflowScrolling: 'touch', padding: '0 20px 8px' }}>
              ...
              <div style={{ marginBottom: 16, position: 'relative' }}>
                ...
                <input type="text" placeholder="e.g. Reliance, HDFC Bank, Infosys\u2026"
                ...
                {results.length > 0 && !selected && (
                  <div style={{ position: 'absolute', left: 0, right: 0, top: '100%', marginTop: 4, background: '#0a0f14', border: `1px solid ${accentBorder}`, borderRadius: 14, overflow: 'hidden', zIndex: 60, maxHeight: 280, overflowY: 'auto' }}>
                    {results.map(s => (
              ...
              <label style={{ display: 'block', marginBottom: 20 }}>
                ...
                <input type="text" placeholder="Broker, DEMAT account\u2026"
            ...
            {/* \u2500\u2500 Sticky footer \u2500\u2500 */}
            <div style={{ flexShrink: 0, padding: '12px 20px', paddingBottom: 'calc(env(safe-area-inset-bottom) + 16px)', borderTop: `1px solid ${accentBorder}`, background: 'linear-gradient(180deg,#00080f 0%,#000608 100%)' }}>

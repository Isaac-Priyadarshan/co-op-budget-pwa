...
// ticker key maps to sync-prices handler
...
export function PreciousMetalAssetSheet({ open, onClose, onSave }: Props) {
  ...
  const [buyRate, setBuyRate] = useState('')   // ₹ per gram at purchase
        ...
        <>
          ...
          <motion.div key="pm-sh"
            ...
            style={{
              ...
              border: `1px solid ${meta.border}`, borderBottom: 'none',
          ...
          >
            ...
            {step === 'form' && metal && (
              <>
                ...
                <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.28)', marginBottom: 18, lineHeight: 1.5 }}>📡 Daily midnight sync pulls live {metal.toLowerCase()} price in INR and updates your value + P&amp;L.</p>

      ...
      {open && (
        <>
          ...
          >
            ...
            {/* \u2500\u2500 Sticky footer \u2500\u2500 */}
            <div style={{ flexShrink: 0, padding: '12px 20px', paddingBottom: 'calc(env(safe-area-inset-bottom) + 16px)', borderTop: `1px solid ${accentBorder}`, background: 'linear-gradient(180deg,#0a0614 0%,#060310 100%)' }}>
